...
\usepackage[english,intoc]{nomencl}												% create list of abbreviations (add it to TOC)
\usepackage{datetime}
...
% \renewcommand{\nomname}{Abk�rzungsverzeichnis}						% rename title of list to the matching german word
...
\hypersetup{% �=\304; �=\326; �=\334; �=\344; �=\366; �=\374; �=\377
  pdftitle={Design and Evaluation of a High Performance Vector Processor Memory Architecture for CNN-Based Scene Labelling Algorithms},
  pdfauthor={Somer Kelef},
  pdfsubject={Design and Evaluation of a High Performance Vector Processor Memory Architecture for CNN-Based Scene Labelling Algorithms}
}
...
%
\thispagestyle{plain}
\textbf{Statement of originality\\[2ex]}
\setstretch{1.2}
\normalsize
I hereby confirm that I have written the accompanying thesis by myself, without 
contributions from any sources other than those cited in the text and acknowledgments.
This applies also to all graphics, drawings and images included in the thesis.

\vspace{3cm}

\begin{tabularx}{0.97\textwidth}{p{4cm} X p{5cm}}
	\hrulefill & ~ & Hannover, \shortdate\today\\
	Somer Kelef
\end{tabularx}
\clearpage
\newpage
