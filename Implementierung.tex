...
\begin{itemize}
	...
	\item Lastkapazität\\
		Da die Lastkapazität ebenfalls eine Rolle bei der Berechnung der dynamischen Verlustleistung spielt, wurde diese Ebenfalls als Fitness-Funktion verwendet. Hierbei wurde für jede Adress-Leitung die entsprechende Lastkapazität aus den Power-Reports. Ermittelt. Um die einzelnen Allokations-Ansätze vergleichen zu können, wurden die Kapazitäten aufsummiert. Der Ansatz mit der niedrigsten Belastung wird als Mapping verwendet. 
	...
	\item gewichtete Funktion\\
		Als weitere Erweiterung wurde zusätzlich eine Gewichtung der Hamming-Distanz und der Lastkapazität eingefügt um den Einfluss der beiden Faktoren zu beeinflussen und somit die Verlustleistung bestmöglich anzugleichen.
\end{itemize}
