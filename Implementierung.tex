...
\section{Ansatz}
\label{chap:ansatz}
Das Ziel des Algorithmus ist es, eine geeignete Register-Allokation zu finden, bei der die Verlustleistung minimal wird. Um dies zu erreichen soll der Freiheitsgrad ausgenutzt werden der durch den Einsatz von virtuellen Registern entsteht.
