...
Das Schaubild \ref{fig:compare_genetic_modes} zeigt, wie sich der Einsatz von verschiedenen Fitness-Funktionsansätze auf die Gesamtleistung des Prozessors auswirkt. Da der genetische Algorithmus zufalls gesteuert ist, wurden die verschiedenen Algorithmen-Ansaetze mit den selben Seed ausgefuehrt. Dadurch koennen die Ergebnisse untereinander verglichen werden. Hierbei ist zu erkennen, dass eine Kombination aus Lastkapazität und Hamming-Distanz die besten Ergebnisse liefert.
...
Die Tabelle \ref{tab:algo_conifg} zeigt die Algorithmus-Modi des genetischen Algorithmus sowie der Heuristiken und verdeutlicht die Einstellungsmöglichkeiten der Registerallokation. Diese Variablen können übergeben werden und wurden so gewählt, dass die einzelnen Versionen bessere getestet werden können . Diese Varibalen können beim aufrufen des Schedulers 
Alle weiteren Variablen können nur innerhalb des Algorithmus geaender werden.
