...
Der Prozessor wird für die Implementierung auf einem ASIC entwickelt und wird zur Verifikation auf einem FPGA getestet, da dieser eine hohe Flexibilität, sowie geringere Entwicklungszeiten bietet und die spätere Hardware eins zu eins Abgebildet werden kann.\cite{lukasglitches2017}
Bei ASICs handelt sich sich um anwendungsspezifische Schaltungen, hierbei ist die komplette Funktion in Hardware gefertigt und ist somit äußerst performant und gleichzeitig energie-effizient.  
