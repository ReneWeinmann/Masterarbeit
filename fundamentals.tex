...
\begin{algorithm}[H]
	\begin{algorithmic}[1]
		\STATE {:0 \textbf {MVI} V0R0 0x100 }
		\STATE {:0 \textbf {MVI} V0R1 0x101 }
		\STATE {:0 \textbf {ADD} V0R0 V0R0 V0R1 }
		\STATE {:0 \textbf {STORE} 0x100 V0R0 }
...
\begin{algorithm}[H]
	\begin{algorithmic}[1]
		\STATE {:0 \textbf {MVI} VxR0 0x100 }
		\STATE {:0 \textbf {MVI} VxR1 0x101 }
		\STATE {:0 \textbf {ADD} VxR0 VxR0 VxR1 }
		\STATE {:0 \textbf {STORE} 0x100 VxR0 }
