...
Das beschriebene Problem verursacht eine Erhöhung der Schaltaktivität auf den Adressleitungen. Dadurch steigt die Verlustleistung in den einzelnen Adress-Ports um teilweise XXX\%
...
\begin{figure}[H] 
	\centering
	\includesvg[width=\textwidth]{heuristik_eval_worst}
...
Da der genetische Algorithmus zufallsgesteuert ist, variieren die Ergebnisse stark. Um dennoch eine Aussage über die Verbesserung gegenüber der Heuristik treffen zu können, wurden die Testfälle fünf mal ausgeführt und aus den Ergebnissen ein Mittelwert gebildet. Das Schaubild XXX zeigt hierbei wie stark die Ergebnisse untereinander variieren. Es ist jedoch deutlich zu erkennen, dass in jedem Fall eine Verbesserung der Schaltleistung erzielt werden konnte.

genetischer Algo fünf werte pro testfall in einem Diagramm

In der besten Variante des genetischen Algorithmus, ist eine Verbesserung der Hamming-Distanz von XXX\% zu erreichen. Diese verursacht eine Optimierung der Schaltleistung um XXX\% und der Gesamtleistung um XXX\%.
